<template>
  <div id="app">
    <div id="inputs">
      <h4>Labels</h4>
      <input type="text" v-model="model.label1" />
      <input type="text" v-model="model.label2" />
      <input type="text" v-model="model.label3" />
      <input type="text" v-model="model.label4" />
      <input type="text" v-model="model.label5" />
      <input type="text" v-model="model.label6" />
      <input type="text" v-model="model.label7" />
      <input type="text" v-model="model.label8" />
      <input type="text" v-model="model.label9" />
      <input type="text" v-model="model.label10" />
      <input type="text" v-model="model.label11" />
      <input type="text" v-model="model.label12" />
      <input type="text" v-model="model.label13" />
      <input type="text" v-model="model.label14" />
      <input type="text" v-model="model.label15" />
      <input type="text" v-model="model.label16" />
      <input type="text" v-model="model.label17" />
      <h4>QR Code Data</h4>
      <label>name</label><input class="qr" type="text" v-model="model.name" />
      <label>phone</label><input class="qr" type="text" v-model="model.phone" />
      <label>email</label><input class="qr" type="text" v-model="model.email" />
    </div>
    <div id="preview">
      <h4>Preview</h4>
      <canvas width="262" height="426" style="border:1px solid #BBB;" v-insert-message="model"></canvas>
    </div>
  </div>
</template>
...
export default {
  ...
  directives: {
      insertMessage: function(canvas, binding) {
          clearCanvas(canvas);
          drawMujiLabelCanvas(canvas, makeRect(0, 0, 262, 426), undefined, binding.value);
      }
  }
}
...
function drawMujiLabelCanvas(canvas, targetFrame, resizing, model) {
    ...
    context.fillText(model.label17, labelRect.x + labelRect.w/2, labelRect.y + 8 + labelRect.h / 2 - labelTotalHeight / 2);
    ...
    context.fillText(model.label16, label5Rect.x + label5Rect.w/2, label5Rect.y + 5 + label5Rect.h / 2 - label5TotalHeight / 2);
    ...
    context.fillText(model.label15, label6Rect.x + label6Rect.w/2, label6Rect.y + 8 + label6Rect.h / 2 - label6TotalHeight / 2);
    ...
    let qrcontext = canvas.getContext('2d');

    context.drawImage(canvas, 5, 162, 46, 46);
